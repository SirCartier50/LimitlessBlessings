      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Discover premium lifestyle and wellness products that bring limitless blessings to your life. 
              We curate the finest quality items to enhance your daily well-being.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center">
              ...
              <span className="text-gray-300">hello@limitlessblessings.com</span>
            </div>
            <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-300">123 Blessing Street, Wellness City</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Limitless Blessings. All rights reserved.
          </p>
